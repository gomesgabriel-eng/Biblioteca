        ...
        >
          <View style={styles.header}>
            ...
            <View style={styles.notification}>
              <Text style={styles.notificationIcon}>🔔gi</Text>
            </View>
          </View>
          ...
          >
            ...
            <Text style={styles.category}>Comercio</Text>
          </ScrollView>

          <BookCard
            image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjlnYBaIirLUqf5DEPslvOAzKs0HwXeb80leSB7hXq7w&s=10"
            title="Livros"
          ...
          <BookCard
            image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgd3c3ppeyk8fhpkiS-hSxkv9gkZp2ApPH5dCYZlfMaQ&s=10"
            title="Romance"
          ...
          <BookCard
            image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTB2SRXb-uSkizJlJizvP8uu3XnzVRCtW-xDtfuf_zWvw&s"
            title="Historia"
